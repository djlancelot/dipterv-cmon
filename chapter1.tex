...
After knowing the necessary parameters the getObservation property can be called. This command shows the measured values for some given observations. The input can be complex, it can contain multiple sensors, their multiple ...

\begin{lstlisting}[caption={JSON DescribeSensor POST response\label{lst:getobs}}]
{
