...
Each node has some kind of Linux based operating system. The example applications are all Java based, but other applications will be possible in the future.
